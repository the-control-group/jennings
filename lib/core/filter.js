...
var ops = {
	...
	// -----
	// 
	// Asserts that the `path` exists and its value exactly equal `value`.

	equal: function equal(criterion, clue){
	...
	gte: function gte(criterion, clue){
	...
	lte: function lte(criterion, clue){
